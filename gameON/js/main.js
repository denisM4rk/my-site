...
let button = document.getElementsByClassName('banner__button');
let toggle = document.getElementById('banner__button');
let modal = document.getElementById('ask-question');
let close = document.querySelector('.modal__close');

toggle.onclick =  function(){
  modal.classList.add('modal--open');
  modal.classList.remove('page__modal');
  modal.classList.remove('modal');
}

close.onclick =  function(){
  modal.classList.remove('modal--open');
  modal.classList.add('page__modal');
